...
public class InstockTest {
    ...
    private Product product;    // продуктите
    ...
    public void testChangeQuantityThrowsWhenProductNotPresent() {
    ...
    private List<Product> addProduct() {
        List<Product> products = List.of(new Product("test_label_1", DUPLICATED_PRICE, 50),
    ...
    @Test
    public void testFindByIndexShouldReturnProductWithMatchingLabel() {
        instock.add(product);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testFindByIndexShouldThrowWhenLabelIsMissing() {
    ...
    @Test
    public void testFindFirstByAlphabeticalOrderShouldReturnProductsOrderedByLabel() {
    ...
    @Test
    public void testFindAllInPriceRangeShouldReturnInDescendingOrder() {
        List<Product> expectedProducts = addProduct()
                .stream()
    ...
    @Test
    public void testFindAllInPriceRangeShouldReturnEmptySetWhenNoneMatches() {
        double maxPrice = addProduct().stream()
                .mapToDouble(Product::getPrice)
                .max()
                .orElse(0.00);
    ...
    @Test
    public void testFindAllByPriceShouldReturnMatchingPricesOnly() {
        addProduct();
    ...
    @Test
    public void testFindFirstMostExpensiveProductsShouldReturnCorrectCountOfProducts() {
        addProduct();
        int count = 3;
    ...
    public void testIterableAllProduct (){
        ...
        List<Product> actualProduct = StreamSupport.stream(iterable.spliterator(),false)
                .collect(Collectors.toList());
        assertProductsListEqual(expectedProducts,actualProduct);
    }
}
