...
public class DatabaseTest {
    ...
    public void testConstructorHasCreateCorrectObject() {
        ...
        Assert.assertArrayEquals("Arrays are not the same!", NUMBERS, databaseElement);
    ...
    @Test(expected = OperationNotSupportedException.class)
    public void testConstructorThrowExceptionWhenLassOneElement() throws OperationNotSupportedException {
        Integer[] numbres = new Integer[0];
        new Database(numbres);
    }
    ...
    public void testRemoveLastElement() throws OperationNotSupportedException {
        //database
        //elements: {3, 4, 5, 8, 9, 10} -> 6 броя
        Integer[] elementBefore = database.getElements();
        database.remove();
